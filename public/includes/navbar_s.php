    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../DBQuery/StaffQuery.php?action=stock">Stock Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="../DBQuery/StaffQuery.php?action=loan">Loan Management</a>
                </li>
                <li class="nav-item">
