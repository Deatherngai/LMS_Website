...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../public/LB_info.php">Contact US</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="py-4">
        <main class="form-signin w-100 m-auto">
            <form action="../DBQuery/AccountQuery.php" method="POST">
                <input type="text" class="form-control" name="action" value="SignIn" style="display:none;">
